...
<head>
  ...
  <link rel="icon" href="assets/images/ostad.png" type="image/x-icon">
  <link rel="shortcut icon" href="assets/images/ostad.png" type="image/x-icon">
          ...
          <ul class="nav-menus">
            ...
            <li class="onhover-dropdown">
              ...
              <ul class="notification-dropdown onhover-show-div">
                ...
                <li>
                  <p>
                    <i class="fa fa-circle me-2 font-primary"></i>user create succesful<span class="pull-right">10 min.</span>
                  </p>
                </li>
                <li>
                  <p>
                    <i class="fa fa-circle me-2 font-success"></i>Admin Add another user<span class="pull-right">1 hr</span>
                  </p>
                </li>
                <li>
                  <p>
                    <i class="fa fa-circle me-2 font-info"></i>Admin update succesful<span class="pull-right">3 hr</span>
                  </p>
                </li>
                <li>
                  <p>
                    <i class="fa fa-circle me-2 font-danger"></i>Manager add Complete<span class="pull-right">6 hr</span>
                  </p>
                </li>
                <li>
