        ...
        <div class="col">
          <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
            <ol class="breadcrumb mb-0">
              ...
              <a href="../logout.php"><button type="button" class="btn btn-primary mx-auto">Log Out</button></a>
        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              ...
              <p class="text-muted mb-1">PHP & Laravel Developer</p>
              <p class="text-muted mb-4">Mirpur - 10 , Dhaka , Bangladesh</p>
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0">+880-1744-00000</p>
                </div>
              </div>
              <hr>
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0">Mirpur - 10 , Dhaka , Bangladesh</p>
                </div>
              </div>
            </div>
          </div>
